...
class _EditBankAccountScreenState extends State<EditBankAccountScreen> {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(widget.bank == null ? 'Bank account added' : 'Bank account updated'),
          ),
        );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(widget.bank == null ? 'Add Bank Account' : 'Edit Bank Account'),
        elevation: 0,
      ),
      body: GestureDetector(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              const Text("Select Bank", style: TextStyle(fontWeight: FontWeight.w600)),
              ...
              const Text("Account Details", style: TextStyle(fontWeight: FontWeight.w600)),
