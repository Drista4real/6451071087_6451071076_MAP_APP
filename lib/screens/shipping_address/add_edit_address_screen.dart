...
class _EditAddressScreenState extends State<EditAddressScreen> {
  ...
  void _loadWardsFromCity(String? cityName) {
    ...
    if (city != null) setState(() => _wards = city['districts'] ?? city['wards'] ?? []);
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(widget.address == null ? 'New Shipping Address' : 'Edit Address'),
        elevation: 0,
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: _inputDecoration(Icons.signpost_outlined, label: "Street Name"),
                  validator: (v) => (v == null || v.isEmpty) ? 'Enter street name' : null,
                ),
                const SizedBox(height: 16),
                // Số nhà
                TextFormField(
                  controller: _numberController,
                  decoration: _inputDecoration(Icons.home_outlined, label: "House Number / Building"),
                  validator: (v) => (v == null || v.isEmpty) ? 'Enter house number' : null,
                ),
                const SizedBox(height: 16),
                // Switch Set Default
                Container(
                  ...
                  child: SwitchListTile(
                    ...
                    title: const Text('Set as default address', style: TextStyle(fontSize: 15)),
